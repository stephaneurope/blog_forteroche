...
session_start();?>
    <div class="container admin add">
        <div class="row ">
            ...
            <br>
            <form class="form" role="form" action="index.php?action=newPost" method="post" enctype="multipart/form-data">
                ...
                <br>
                <div class="form-actions"> <a href="index.php?action=board" type="submit" class="btn btn-success"><span class="glyphicon glyphicon-pencil"></span> Ajouter</a> <a class="btn btn-primary" href="index.php?action=board"><span class="glyphicon glyphicon-arrow-left"> Retour</span></a> </div>
            </form>
        </div>
    </div>