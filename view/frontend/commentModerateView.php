...
<?= $comment['id']?>" method="post" enctype="multipart/form-data">
                ...
                <input value="<?= $comment['comment_date_fr'] ?>">
                <a class="pouce" href="index.php?action=reability&amp;id=<?= htmlspecialchars($comment['id']) ?>"> <span class="glyphicon glyphicon-thumbs-up"></span></a>
                <br/>
