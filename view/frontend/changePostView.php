...
<?= $comment['id']?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-actions">
                    <button type="submit" class="btn btn-success"><span class="glyphicon glyphicon-pencil"></span> Valider</button><a class="btn btn-danger" href="index.php?action=board"><span class="glyphicon glyphicon-remove"> Suprimer</span></a> <a class="btn btn-primary" href="index.php?action=board"><span class="glyphicon glyphicon-arrow-left"> Retour</span></a> </div>
            </form>
        </div>
    </div>